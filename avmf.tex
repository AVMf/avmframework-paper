...
%% MAIN TODO: get article back in length by cutting/re-organizing content -- don't remove any refs please!
%% Currently 1/2 page over as of 26/May/2016
...
%% TODO get abstract and intro back into one page. Could tightening -ve \vspacing but there is some flab in the text that could be optimized also
...
The following shows the output of the search process and the discovery of one of the roots ($-1.5$). Re-running the search from different starting positions leads to the other root, $-1$, also being found.

\snippet{search-output}

As part of future work, we plan to extend the example set with case studies showing how the AVM is or can be applied to real SBSE problems, such as test data generation. These will be made available via the GitHub repository.
...
Afshan, S., McMinn, P., Stevenson, M.: Evolving readable string test inputs
	using a natural language model to reduce human oracle cost. In: Proc. ICST (2013)
...
\bibitem{Fraser2013}
Fraser,\,G.,\,Arcuri,\,A.,\,McMinn,\,P.: Test suite generation with memetic algorithms. In: Proc. GECCO (2013)

\bibitem{Fraser2015b}
Fraser,\,G.,\,Arcuri,\,A.,\,McMinn,\,P.:\,A\,memetic\,algorithm\,for\,whole\,test\,suite\,generation.\,JSS\,(2015)

\bibitem{Fraser2013b}
Fraser, G., Staats, M., McMinn, P., Arcuri, A., Padberg, F.: Does automated
	white-box test generation really help software testers? In: Proc. ISSTA (2013)

\bibitem{Fraser2015}
Fraser, G., Staats, M., McMinn, P., Arcuri, A., Padberg, F.: Does automated
	unit test generation really help software testers? a controlled empirical
	study. ACM TOSEM  (2015)

\bibitem{Harman2007}
Harman, M., McMinn, P.: A theoretical and empirical analysis of evolutionary
	testing and hill climbing for structural test data generation. In: Proc. ISSTA
	(2007)
...
\bibitem{Kempka2013}
Kempka, J., McMinn, P., Sudholt, D.: A theoretical runtime and empirical
	analysis of different alternating variable searches for search-based testing.
	In: Proc. GECCO (2013)
...
\bibitem{Kukunas2010a}
Kukunas, J., Cupper, R.D., Kapfhammer, G.M.: A genetic algorithm to improve
	{L}inux kernel performance on resource-constrained devices. In: Proc. GECCO (2010)

\bibitem{Lakhotia2010}
Lakhotia, K., Harman, M., Gross, H.: {AUSTIN: A} tool for search based software
	testing for the {C} language and its evaluation on deployed automotive
	systems. In: Proc. SSBSE (2010)

\bibitem{Lakhotia2013}
Lakhotia, K., Harman, M., Gross, H.: {AUSTIN: A}n open source tool for search
	based software testing of {C} programs. IST  (2013)

\bibitem{McMinn2007}
McMinn, P.: {IGUANA:} {I}nput {G}eneration {U}sing {A}utomated {N}ovel
	{A}lgorithms. a plug and play research tool. Tech. Rep. CS-07-14, Dept. Computer Science,
	University of Sheffield, UK (2007)
...
Yue, T., Ali., S.: Applying search algorithms for optimizing stakeholders
	familiarity and balancing workload in requirements assignment. In: Proc. GECCO
	(2014)

\bibitem{Yue2016}
Yue, T., Ali, S., Lu, H., Nie., K.: Search-based decision ordering to
	facilitate product line engineering of cyber-physical system. In: Proc. MODELSWARD
	(2016)

\bibitem{Zhong2015}
Zhong, H., Su, Z.: An empirical study on real bug fixes. In: Proc. ICSE (2015)
