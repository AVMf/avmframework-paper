...
The original AVM algorithm itself has been subject to improvements, including the ability to handle floating-point variables~\cite{Harman2007} and strings~\cite{McMinn2015}, along with the incorporation of different strategies that are proven to speed up the search for certain common types of objective function landscape
\cite{%Kempka2013,
Kempka2015}.
...
However, the {\tt objective} package also supplies the concrete {\tt NumericalObjectiveValue} class for returning higher-is-better or lower-is-better numerical objective values.
\end{sloppypar}
